 ...
 */
public class VeryCoolWeatherOpenHelper extends SQLiteOpenHelper {
    ...
    public VeryCoolWeatherOpenHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
